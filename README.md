...
2026-09-08、版2区間付き構築統合後（直前基準 `4847800`）。最新の受入範囲と履歴は [実装状況](docs/IMPLEMENTATION_STATUS.md)。
...
| 検証 | 標準349件中347合格・2 skip。Pillbox/Bessel場、球形独立参照、楕円/双曲線の幾何・FEM細分、RF、保存、GUI等。数値・ブラウザー受入は個別記録を参照 |
...
直線と弧の接線/フィレット・全要件照合が残ります。保存・Case/CLI/GUIは接続済みです。
