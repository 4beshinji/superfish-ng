...
from test_curved_hphi_tracking_jobs import pair
from superfish_ng.curved_hphi_tracking_history import CurvedHphiTrackingHistoryRequest


class CurvedHphiTrackingGuiTests(unittest.TestCase):
    def test_strict_gui_start_restore_original_side_and_repeat_from_owned_sources(self):
        with tempfile.TemporaryDirectory() as t,ExitStack() as cleanup:
            ...
            history_request=CurvedHphiTrackingHistoryRequest(1).to_dict()
