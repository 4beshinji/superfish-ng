...
def main():
    ...
    for point in report['points']:
        ...
        rows.append(dict(value=point['value'],analytical_mode_labels=[r[1] for r in exact],frequency_relative_errors=errors))
    ...
    final=dict(status='PASS',scope='three analytical cylinder modes crossing ranks via declared geometry laws, harmonic mesh motion and curved piecewise comparison; not general branch recovery',
