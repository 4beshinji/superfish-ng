...
try {
  ...
  if (args["--tangent-request"]) {
    ...
    if ([2,3,5,6].includes(built.request.schema_version)) {
      if (built.schema_version !== built.request.schema_version || built.enumeration.arc_filter_status !== ({2:"CERTIFIED_MEMBERSHIP_AND_FRACTIONS",3:"CERTIFIED_FIXED_LINE_CONTACT",5:"CERTIFIED_CONIC_FILLET_CONTACTS",6:"CERTIFIED_CONIC_FILLET_CONTACTS"}[built.schema_version])) throw Error("GUI lost certified construction version");
