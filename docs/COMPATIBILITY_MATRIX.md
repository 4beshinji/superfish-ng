...
更新: 2026-09-08、D01区分アフィン再メッシュのGUI接続後（直前基準 `8870204`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
