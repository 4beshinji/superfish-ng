...
更新: 2026-09-08、D01区分アフィン再メッシュ比較追加後（直前基準 `a24c12e`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
