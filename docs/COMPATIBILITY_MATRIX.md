...
| K28 | 多極成分・力・トルク | H | 部分 | [平面多極のB-H/反跳native](PLANAR_MAGNETIC_MULTIPOLE_MATERIAL_NATIVE.md)と[平面磁場の力・トルク報告保存・CLI](PLANAR_MAGNETIC_FORCE_NATIVE.md)を限定受入。GUI受渡し・B-H/反跳/軸対称の力/トルクは未完 | B / S05 |
