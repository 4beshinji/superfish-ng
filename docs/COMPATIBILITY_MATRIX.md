...
更新: 2026-09-08、D01多対多の集合継承追加後（直前基準 `7eedad8`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
