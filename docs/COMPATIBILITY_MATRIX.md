...
更新: 2026-09-08、N04曲線残差指標追加後（直前基準 `6261292`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
