...
| K02 | 楕円・双曲線・接線接続 | D（NT=2楕円/3双曲線）、U（接線操作） | 部分：native楕円/双曲線・接続検査・弦GUI、[曲線P2/保存/描画/固定幾何Study](CURVED_ELEMENTS.md) | 接線構築・曲線ピーク/鏡映/GUI・総合収束、旧曲線パラメータと対象版での実行検証 | A / C00,G03 |
