...
更新: 2026-09-08、D01アフィン変形の独立再メッシュ比較追加後（直前基準 `9635929`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
