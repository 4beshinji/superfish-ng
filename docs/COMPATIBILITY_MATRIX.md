...
| K26 | 非線形BH・材料曲線 | H | 部分 | [単調H(B)表](BH_CURVE.md)、[平面P1解/保存](PLANAR_BH_NATIVE.md)、[軸接続P1解/保存](AXIS_BH_NATIVE.md)と[軸非接続P1の境界付き非線形磁静場](OFF_AXIS_BH_SOLVE.md)を限定受入。解析/独立1次元BVP比較済み。軸非接続の保存/CLI・対象版モデルは未完 | B / S04 |
