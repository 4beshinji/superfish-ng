...
更新: 2026-09-08、D01多対多集合継承のGUI接続後（直前基準 `6f011b7`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
