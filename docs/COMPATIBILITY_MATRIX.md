...
更新: 2026-09-08、D02周波数調整のGUI接続後（直前基準 `0b40a5e`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
...
| K18 | 周波数調整・制約付き最適化 | U | 部分：[追跡付き1変数tune・再開・細メッシュ判定API/CLI・JobManager・GUI](TUNING.md) | 一般形状/連動変数・制約付き最適化・旧tuner照合 | A / D02,D03 |
