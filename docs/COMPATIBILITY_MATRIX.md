...
更新: 2026-09-08、N03直線離散ピーク囲い込み追加後（直前基準 `972f46e`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
...
| K15 | 表面ピークE/B | L | 部分：P1/P2片側場、[直線P1/P2の連続離散ピーク囲い込みAPI/保存/CLI](AFFINE_SURFACE_EXTREMA.md)、曲線離散場の連続極値の囲い込み、曲線角診断、[追跡済み固定幾何細分評価API/CLI/GUI](SURFACE_CONVERGENCE.md) | 固定丸め半径で収束、境界評価位置/規約の一致 | A / N03 |
