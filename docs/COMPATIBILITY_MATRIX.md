...
| K28 | 多極成分・力・トルク | H | 部分 | [平面多極のB-H/反跳native](PLANAR_MAGNETIC_MULTIPOLE_MATERIAL_NATIVE.md)と[軸を含まない軸対称磁場の軸方向力](OFF_AXIS_MAGNETIC_FORCE.md)を限定受入。軸方向力保存/CLI・GUI受渡し・軸接続とB-H/反跳の軸対称力は未完 | B / S05 |
