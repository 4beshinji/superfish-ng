...
| K28 | 多極成分・力・トルク | H | 部分 | [平面多極のB-H/反跳native](PLANAR_MAGNETIC_MULTIPOLE_MATERIAL_NATIVE.md)と[検証済み磁気後処理量のGUI受渡し](S05_GUI_HANDOFF.md)を限定受入。原要件/対象版確認と未対応な軸接続/B-H/反跳の軸対称力は未完 | B / S05 |
