...
更新: 2026-09-08、N04曲線局所細分基盤追加後（直前基準 `9af9cf6`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
