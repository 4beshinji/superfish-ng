...
更新: 2026-09-08、N04曲線局所履歴のnative統合後（直前基準 `84a49e4`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
