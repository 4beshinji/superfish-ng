...
更新: 2026-09-08、D01/N04曲線親子追跡追加後（直前基準 `8ae8037`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
