...
更新: 2026-09-08、N04選択要素の適合細分基盤追加後（直前基準 `7c70334`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
...
| K06 | 高次要素・誤差推定・適応細分 | U | 部分：P1と実長細分、[P2場/RF/保存・表示](HIGH_ORDER_FIELDS.md) | P2場/RFは受入済み。[選択直線要素の細分・係数移送API](MARKED_REFINEMENT.md)を追加。適応誤差推定・自動選択/停止は未実装。旧アルゴリズムの再現要件ではない | A / N01,N02,N04 |
