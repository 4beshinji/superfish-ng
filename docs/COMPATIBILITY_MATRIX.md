...
更新: 2026-09-08、N03固定幾何の表面収束評価追加後（直前基準 `904c72b`）。最新の親課題状態は [計画冒頭](COMPATIBILITY_PLAN.md)。
...
| K15 | 表面ピークE/B | L | 部分：P1/P2片側場、曲線離散場の連続極値の囲い込み、角診断、[追跡済み固定幾何細分評価API/CLI](SURFACE_CONVERGENCE.md) | 固定丸め半径で収束、境界評価位置/規約の一致 | A / N03 |
