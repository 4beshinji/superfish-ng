...
| K26 | 非線形BH・材料曲線 | H | 部分 | [単調H(B)表](BH_CURVE.md)、[平面P1解/失敗保存](PLANAR_BH_NATIVE.md)と[軸接続P1の解/保存](AXIS_BH_NATIVE.md)、[軸非接続P1弱形式](OFF_AXIS_BH_FORMS.md)を限定受入。軸非接続境界付き反復/失敗保存・対象版モデルは未完 | B / S04 |
