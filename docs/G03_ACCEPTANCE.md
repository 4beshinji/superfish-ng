...
2026-09-08、中心軌跡交点探索追加時。G03は**部分受入**。
...
| 円錐曲線弧を含むフィレット | normal_offsets.pyで法線方向の中心軌跡/導関数を有理数区間で囲み、正則/反転/潰れ/未確認を全有限区間に保持。offset_intersections.pyで有限領域の孤立交点を包含認証 | **未完**。線分中心軌跡、弧端/重解/無限解、有限接点、選択/切詰め、保存/CLI/GUI、独立形状/FEM検証が必要 |
...
中心軌跡の孤立交点探索を追加し、次は根箱からの有限接点と有向フィレット構築。
