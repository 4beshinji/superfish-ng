...
| 平面の線形永久磁石・異方性 | 明示主軸mu_r/Brem・向き、三荷重、元Az/B/Hと二つの基準付き構成ポテンシャル | 保存/CLI・軸対称・対象版モデル確認・GUI/Project/Study・非線形等は未実装 | [PLANAR_RECOIL_SOLVE.md](PLANAR_RECOIL_SOLVE.md) |
