...
| 等方非線形B-H構成則・平面/軸接続P1 | 単調表/来歴、平面の境界付き解/失敗保存/CLI、軸接続のg/K/全J U/U*と一定a試験・独立微分 | 軸対称境界付き反復/保存・対象版確認は未実装 | [BH_CURVE.md](BH_CURVE.md)、[AXIS_BH_FORMS.md](AXIS_BH_FORMS.md) |
