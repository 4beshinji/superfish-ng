...
| 線形RF材料 | 全直線セルを明示材料領域へ割当、q/uの材料重み付き実FEM、元E/H/B・領域エネルギー・非磁性壁損失、真空軸区間の加速量 | 正値・実数・等方・無損失のみ。材料native/CLI/GUI・体積損失・分散等は未実装 | [MATERIAL_HPHI_FORMS.md](MATERIAL_HPHI_FORMS.md)、[MATERIAL_HPHI_RF.md](MATERIAL_HPHI_RF.md) |
