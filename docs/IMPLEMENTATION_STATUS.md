...
| 等方非線形B-H構成則・平面P1弱形式 | SIの単調表/来歴、元H・接線・U/U*、非線形g/Kと電流荷重、定数核と独立微分 | 境界付き反復/保存・軸対称・独立ソルバー比較・対象版確認は未実装 | [BH_CURVE.md](BH_CURVE.md)、[PLANAR_BH_FORMS.md](PLANAR_BH_FORMS.md) |
