...
| 平面磁場の多極表現/抽出 | 反跳/B-Hモデルの線形無源領域での多極抽出を限定受入。明示normal/skew[T]/frame | 材料報告の保存/CLI・GUI受渡し・力/トルクは未実装/未確認 | [PLANAR_MAGNETIC_MULTIPOLE_MATERIALS.md](PLANAR_MAGNETIC_MULTIPOLE_MATERIALS.md) |
