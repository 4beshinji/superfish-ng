...
| 等方非線形B-H構成則・平面/軸接続P1 | 単調表/来歴・元H/実接線、平面の解/保存、軸接続P1非線形磁場の保存・失敗再現・CLIを限定受入 | 軸非接続非線形・対象版モデルは未実装/未確認 | [BH_CURVE.md](BH_CURVE.md)、[AXIS_BH_NATIVE.md](AXIS_BH_NATIVE.md) |
