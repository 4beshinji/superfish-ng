...
| 平面磁場の多極表現/抽出 | 平面磁場の有限多極表現と座標変換を限定受入。明示normal/skew[T]/frame | 元FEM抽出・保存/CLI・GUI受渡し・対象材料・力/トルクは未実装/未確認 | [PLANAR_MAGNETIC_MULTIPOLES.md](PLANAR_MAGNETIC_MULTIPOLES.md) |
