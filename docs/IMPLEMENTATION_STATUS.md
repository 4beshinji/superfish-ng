...
| 等方非線形B-H構成則・平面/軸非接続P1 | 単調表/来歴、平面/軸接続の解/失敗保存/CLI、軸非接続g/K/全J U/U*と定数psi核・独立微分 | 軸非接続境界付き反復/保存・対象版確認は未実装 | [BH_CURVE.md](BH_CURVE.md)、[OFF_AXIS_BH_FORMS.md](OFF_AXIS_BH_FORMS.md) |
