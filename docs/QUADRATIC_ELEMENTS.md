...
N02進行による更新（2026-09-08）: HIGH_ORDER_FIELDS.mdに基づき任意点場、
cell_fields、quantitiesはP2対応へ移行した。上記のRF拒否はN01受入時点の履歴。
保存/鏡映の拒否は残り、N02全体の製品統合は未完。

N02追加更新（2026-09-08）: reflect_solutionもP2中点を保持して対応済み。
保存の拒否は残る。上記の鏡映拒否は初期段階の履歴。
