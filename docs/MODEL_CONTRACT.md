...
2026-09-13：[軸対称静電専用native/CLI](ELECTROSTATIC_NATIVE.md)。capabilities.axisymmetric_electrostaticへ専用Case/誘電体分割/native版1、3 CLI、静電SI単位と境界・容量の適用条件を追加した。RFのcanonical Modelや専用Hφ入力は不変。Project/GUI/Studyは未対応。
