...
class PlanarTrackingHistoryRequest:
    ...
    def to_dict(self):
        return dict(format='superfish_ng_planar_tracking_history_request', history_version=1,
    ...
    def from_dict(cls, data):
        ...
        if (data['format']!='superfish_ng_planar_tracking_history_request'
            ...
            raise ValueError('expected superfish_ng_planar_tracking_history_request history_version 1')
...
def verify_planar_history_steps(paths, request):
    ...
    return dict(format='superfish_ng_planar_tracking_history_result',history_version=1,
