...
def capabilities():
    ...
    return {'capabilities_version': 1, 'case_schema_versions': [1, 2, 3],
            ...
            'model_limits': {'te': 'vacuum m=0, straight P1/P2 and curved P2, solve/TE native read/Project/JobManager/GUI; symmetry reflection with source provenance and partial spectrum; normalized-cylinder tracking; parameter sweeps and same-physics refinement diagnostics; other tracking pending'},
