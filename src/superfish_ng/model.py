...
def capabilities():
    ...
    return {'capabilities_version': 1,
            'planar_cutoff': {'case_format': 'superfish_ng_planar_case', 'schema_version': 1, 'schema_versions': [1,2],
                ...
                'tracking_request_format': 'superfish_ng_planar_tracking_request', 'tracking_version': 1, 'tracking_versions': [1, 2, 3, 4, 5, 6],
                ...
                'limits': 'vacuum single PEC boundary; straight P1/P2; no holes, curved geometry, materials or propagation; declared affine tracking requires the exact transformed boundary cycle (independent interior only), so non-affine deformation, boundary-density-independent remeshing and surface-peak accuracy guarantees remain unsupported'}, 'case_schema_versions': [1, 2, 3],
