...
def capabilities():
    ...
    return {'capabilities_version': 1,
            'planar_cutoff': {'case_format': 'superfish_ng_planar_case', 'schema_version': 1, 'schema_versions': [1,2],
                ...
                'tracking_request_format': 'superfish_ng_planar_tracking_request', 'tracking_version': 1, 'tracking_versions': [1, 2, 3, 4, 5],
                ...
                'limits': 'vacuum single PEC boundary; straight P1/P2; no holes, curved geometry, materials, propagation, arbitrary polygon deformation/reflection tracking or surface-peak accuracy guarantee'}, 'case_schema_versions': [1, 2, 3],
