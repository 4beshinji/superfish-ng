...
def capabilities():
    ...
    return {'capabilities_version': 1, 'case_schema_versions': [1, 2, 3],
            ...
            'model_limits': {'te': 'vacuum m=0, straight P1/P2 and curved P2, solve/TE native read/Project/JobManager/GUI; normalized-cylinder tracking; Study and other tracking pending'},
