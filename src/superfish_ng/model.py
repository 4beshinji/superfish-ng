...
from .capability_inventory import static_field_study_gui_capabilities, static_field_study_capabilities, static_field_study_jobs_capabilities
...
def capabilities():
    ...
    return {'capabilities_version': 1,
            ...
            'static_field_study_gui': static_field_study_gui_capabilities(),
            'static_field_study_jobs': static_field_study_jobs_capabilities(),
