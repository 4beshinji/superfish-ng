...
def capabilities():
    ...
    return {'capabilities_version': 1,
            'planar_cutoff': {'case_format': 'superfish_ng_planar_case', 'schema_version': 1, 'schema_versions': [1,2],
                ...
                'tracking_request_format': 'superfish_ng_planar_tracking_request', 'tracking_version': 1, 'tracking_versions': [1, 2, 3],
                ...
                'tracking_scope': 'rectangle Case v1 normalized_rectangle or explicit polygon Case v2 origin uniform scale or declared proper similarity with forward/inverse direction and nested refinement; original electric-field integration; guarded positive prefix bands; finite-enrichment resolution and ID subspaces; no continuous-path identity proof',
