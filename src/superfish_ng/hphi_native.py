...
def hphi_case_from_dict(data):
    ...
    raise ValueError('expected a dedicated coaxial, positive-radius mesh or regular-axis Hphi mesh case')
...
def read_hphi_run(directory):
    ...
    raise ValueError('expected a dedicated coaxial, positive-radius mesh or regular-axis Hphi native manifest')
