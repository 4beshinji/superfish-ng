...
"""Explicit dispatch for the two supported positive-radius Hphi native types."""
...
def hphi_case_from_dict(data):
    ...
    raise ValueError('expected a dedicated coaxial or positive-radius Hphi mesh case')
...
def read_hphi_run(directory):
    ...
    raise ValueError('expected a dedicated coaxial or positive-radius Hphi native manifest')
