    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            try:
                ...
                if action in ("track-study-modes", "compare-modes", "start-mode-history", "extend-mode-history", "recover-mode-identities", "recover-study-mode-identities", "replay-mode-tracking"):
