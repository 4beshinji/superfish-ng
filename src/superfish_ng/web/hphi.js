...
function loadHphiTune(request){
 ...
 const mesh=request.project.case.format==='superfish_ng_coaxial_case'?request.project.case.mesh:request.project.case.geometry?.base_mesh||request.project.case.mesh||request.project.case.fem;
