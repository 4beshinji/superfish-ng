...
from .offset_degeneracies import classify_offset_degeneracies, _classify_offset_degeneracies, _classify_offset_degeneracies_v2, _classify_offset_degeneracies_v3, _classify_offset_degeneracies_v4


def _from_replayed_construction(construction, *, schema_version=5):
    ...
    if type(schema_version) is not int or schema_version not in (1,2,3,4,5):
        raise ValueError('construction offset diagnosis requires schema version 1, 2, 3, 4 or 5')
    ...
    classifier = {1:_classify_offset_degeneracies,2:_classify_offset_degeneracies_v2,3:_classify_offset_degeneracies_v3,4:_classify_offset_degeneracies_v4,5:classify_offset_degeneracies}[schema_version]
