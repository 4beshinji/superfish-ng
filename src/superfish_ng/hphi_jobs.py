...
"""Hphi workers and verified imports for explicit regular-axis or positive-radius geometry."""
import os
import hashlib
    ...
    for relative in ('project.json','solution/case.json','solution/results.json'):
        ...
        if path.is_file():
            ...
            if isinstance(data,dict):
                ...
                if (data.get('format') in ('superfish_ng_hphi_project','superfish_ng_coaxial_case','superfish_ng_coaxial_result','superfish_ng_hphi_mesh_case','superfish_ng_hphi_mesh_result','superfish_ng_axis_hphi_case','superfish_ng_axis_hphi_result')
                        or data.get('physics') in ('axisymmetric_coaxial_hphi_rf','positive_radius_axisymmetric_hphi_rf','axis_connected_axisymmetric_hphi_rf')
                        or isinstance(case,dict) and case.get('format') in ('superfish_ng_coaxial_case','superfish_ng_hphi_mesh_case','superfish_ng_axis_hphi_case')
