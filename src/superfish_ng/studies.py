...
class Study:
    ...
    def __post_init__(self):
        ...
        if not harmonic and any(value is not None for value in (self.geometry_coefficients,self.minimum_corner_angle_deg)):
            raise ValueError('harmonic Study fields require kind curved_harmonic_sweep')
        if harmonic:
